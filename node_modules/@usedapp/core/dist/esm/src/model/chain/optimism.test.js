...
describe('Optimism Chain', () => {
    ...
    it('getExplorerAddressLink', () => {
        ...
        expect(OptimismGoerli.getExplorerAddressLink(TEST_ADDRESS)).to.eq(`https://blockscout.com/optimism/goerli/address/${TEST_ADDRESS}`);
    });
    it('getExplorerTransactionLink', () => {
        ...
        expect(OptimismGoerli.getExplorerTransactionLink(TEST_TX)).to.eq(`https://blockscout.com/optimism/goerli/tx/${TEST_TX}`);
    });
});
