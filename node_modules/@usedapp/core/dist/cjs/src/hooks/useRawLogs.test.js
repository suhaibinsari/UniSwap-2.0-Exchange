        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () { return (0, useRawLogs_1.useRawLogs)(filter); }, { config: config })];
                case 3:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () { return (0, useRawLogs_1.useRawLogs)(filter); }, {
                            config: __assign(__assign({}, config), { readOnlyChainId: network2.chainId })
                        })];
                case 1:
                    _a = _c.sent(), result = _a.result, waitForCurrent = _a.waitForCurrent;
                    return [4 /*yield*/, waitForCurrent(function (val) { return val !== undefined; })];
