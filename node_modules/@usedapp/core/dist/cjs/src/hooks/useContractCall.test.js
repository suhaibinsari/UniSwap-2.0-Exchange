...
describe('useContractCall', function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () { return (0, useContractCall_1.useContractCall)(callData, { chainId: network1.chainId }); }, {
                            config: config
                        })];
                case 1:
    ...
    it('multichain calls return correct initial balances', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testMultiChainUseContractCall(token.address, [network1.deployer.address], network1.chainId, testing_1.MOCK_TOKEN_INITIAL_BALANCE)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, testMultiChainUseContractCall(secondToken.address, [network2.deployer.address], network2.chainId, testing_1.SECOND_MOCK_TOKEN_INITIAL_BALANCE)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    (0, chai_1.expect)(result.error).to.be.undefined;
                    (0, chai_1.expect)((_b = result.current) === null || _b === void 0 ? void 0 : _b[0]).not.to.be.undefined;
                    (0, chai_1.expect)((_c = result.current) === null || _c === void 0 ? void 0 : _c[0]).to.eq(endValue);
                    return [2 /*return*/];
            }
        });
    }); };
