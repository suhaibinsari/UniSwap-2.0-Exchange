...
describe('useChainCall', function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () { return (0, useChainCalls_1.useChainCall)((0, helpers_1.encodeCallData)(callData, network1.chainId)); }, {
                            config: config
                        })];
                case 1:
    ...
    it('multichain calls return correct initial balances', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testMultiChainUseChainCall(token, [network1.deployer.address], network1.chainId, testing_1.MOCK_TOKEN_INITIAL_BALANCE)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, testMultiChainUseChainCall(secondToken, [network2.deployer.address], network2.chainId, testing_1.SECOND_MOCK_TOKEN_INITIAL_BALANCE)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
