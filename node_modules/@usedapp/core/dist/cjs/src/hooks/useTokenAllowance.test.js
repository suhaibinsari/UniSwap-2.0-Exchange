...
describe('useTokenAllowance', function () {
    ...
    it('returns 0 when spender is not yet approved', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () { return (0, useTokenAllowance_1.useTokenAllowance)(token.address, deployer.address, spender.address); }, {
                        config: config
                    })];
                case 1:
    ...
    it('returns current allowance', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () { return (0, useTokenAllowance_1.useTokenAllowance)(token.address, deployer.address, spender.address); }, {
                            config: config
                        })];
                case 2:
                    _a = _b.sent(), result = _a.result, waitForCurrent = _a.waitForCurrent;
    ...
    it('multichain calls return correct initial balances', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testMultiChainUseTokenAllowance(token, deployer.address, spender.address, network1.chainId, testing_1.MOCK_TOKEN_INITIAL_BALANCE.toString())];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, testMultiChainUseTokenAllowance(secondToken, secondDeployer.address, secondSpender.address, network2.chainId, testing_1.SECOND_MOCK_TOKEN_INITIAL_BALANCE.toString())];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var testMultiChainUseTokenAllowance = function (contract, user, spenderUser, chainId, allowance) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () { return (0, useTokenAllowance_1.useTokenAllowance)(contract.address, user, spenderUser, { chainId: chainId }); }, {
                            config: config
                        })];
                case 2:
                    _a = _b.sent(), result = _a.result, waitForCurrent = _a.waitForCurrent;
