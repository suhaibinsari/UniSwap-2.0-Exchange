...
describe('useEthers', function () {
    ...
    describe('Websocket provider', function () {
        var ganacheServer;
        var wsPort = 18845;
        var wsUrl = "ws://localhost:".concat(wsPort);
        before(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ganacheServer = ganache_1["default"].server({ server: { ws: true } });
                        return [4 /*yield*/, ganacheServer.listen(wsPort)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        after(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ganacheServer.close()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('works with a websocket provider', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, result, waitForCurrent;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () { return (0, useEthers_1.useEthers)(); }, {
                            config: {
                                readOnlyChainId: model_1.Mumbai.chainId,
                                readOnlyUrls: (_b = {},
                                    _b[model_1.Mumbai.chainId] = new ethers_1.providers.WebSocketProvider(wsUrl),
                                    _b)
                            }
                        })];
                    case 1:
