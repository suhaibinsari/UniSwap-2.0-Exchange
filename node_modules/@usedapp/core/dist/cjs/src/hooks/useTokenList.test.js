...
describe('useTokenList', function () {
    it('returns token list', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, config, network1, tokens, _b, result, waitForCurrent;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () { return (0, src_1.useTokenList)('http://example.com'); }, { config: config })];
                case 2:
