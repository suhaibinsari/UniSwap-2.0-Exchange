...
describe('useCall - three chains', function () {
    ...
    var _loop_1 = function (chainId) {
        var provider = new ethereum_waffle_1.MockProvider({ ganacheOptions: { chain: { chainId: chainId } } });
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 1:
                    ...
                    _b = _a[_i], chain = _b[1];
                    _c = chain;
                    return [4 /*yield*/, (0, ethereum_waffle_2.deployContract)(chain.deployer, abi_1.timestampContractABI)];
                case 2:
                    _c.timestampContract = _f.sent();
                    _d = chain;
                    return [4 /*yield*/, (0, ethereum_waffle_2.deployContract)(chain.deployer, abi_1.doublerContractABI)];
                case 3:
                    _d.doublerContract = _f.sent();
                    _e = chain;
                    return [4 /*yield*/, (0, ethereum_waffle_2.deployContract)(chain.deployer, abi_1.MultiCall)];
                case 4:
