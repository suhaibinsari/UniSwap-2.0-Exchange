...
describe('useLogs', function () {
    ...
    it('Can get only the recent token transfer log', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0: return [4 /*yield*/, network1.provider.getBlockNumber()];
                case 1:
                    blockNumber = _f.sent();
                    from = network1.deployer;
                    to = network1.wallets[0];
    ...
    it('Can query mint transfer logs by sender', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                return [4 /*yield*/, sendToken(network1.deployer, network1.wallets[1].address, ethers_2.BigNumber.from(1))];
                case 1:
                    // Send to emit another Transfer token that our filter should filter out
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () {
    ...
    it('We get an error when we query by un-indexed values', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: 
                // Send to emit another Transfer token that our filter should filter out
                return [4 /*yield*/, sendToken(network1.deployer, network1.wallets[0].address, ethers_2.BigNumber.from(1))];
                case 1:
                    // Send to emit another Transfer token that our filter should filter out
                    _d.sent();
                    return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () {
    ...
    it('Can query by block hash', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0: return [4 /*yield*/, sendToken(network1.deployer, network1.wallets[0].address, ethers_2.BigNumber.from(1))];
                case 1:
