...
describe('Optimism Chain', function () {
    ...
    it('getExplorerAddressLink', function () {
        ...
        (0, chai_1.expect)(src_1.OptimismGoerli.getExplorerAddressLink(test_defaults_1.TEST_ADDRESS)).to.eq("https://blockscout.com/optimism/goerli/address/".concat(test_defaults_1.TEST_ADDRESS));
    });
    it('getExplorerTransactionLink', function () {
        ...
        (0, chai_1.expect)(src_1.OptimismGoerli.getExplorerTransactionLink(test_defaults_1.TEST_TX)).to.eq("https://blockscout.com/optimism/goerli/tx/".concat(test_defaults_1.TEST_TX));
    });
});
