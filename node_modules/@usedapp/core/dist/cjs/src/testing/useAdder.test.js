...
describe('useAdder', function () {
    it('properly renders without arguments or context wrapper', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, testing_1.renderDAppHook)(useAdder_1.useAdder)];
                case 1:
    ...
    it('properly renders with arguments', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () { return (0, useAdder_1.useAdder)(1, 1); })];
                case 1:
                    firstExample = (_a.sent()).result;
                    return [4 /*yield*/, (0, testing_1.renderDAppHook)(function (_a) {
                            var arg1 = _a.arg1, arg2 = _a.arg2;
                            return (0, useAdder_1.useAdder)(arg1, arg2);
                        }, {
    ...
    it('properly renders with changing arguments', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, testing_1.renderDAppHook)(function (_a) {
                        var arg1 = _a.arg1, arg2 = _a.arg2;
                        return (0, useAdder_1.useAdder)(arg1, arg2);
                    }, {
                        renderHook: { initialProps: { arg1: 1, arg2: 1 } }
                ...
                case 0: return [4 /*yield*/, (0, testing_1.renderDAppHook)(useAdder_1.useAdder, {
                        renderHook: {
                            wrapper: function (_a) {
                                ...
                                return (0, jsx_runtime_1.jsx)(useAdder_1.AdderProvider, __assign({ value: { prov1: 2, prov2: 2 } }, { children: children }));
                            }
                        }
                    })];
                case 1:
                    firstExample = (_a.sent()).result;
                    return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () { return (0, useAdder_1.useAdder)(); }, {
                            renderHook: {
                                wrapper: function (_a) {
                                    var children = _a.children, prov1 = _a.prov1, prov2 = _a.prov2;
                                    return (0, jsx_runtime_1.jsx)(useAdder_1.AdderProvider, __assign({ value: { prov1: prov1, prov2: prov2 } }, { children: children }));
                                },
    ...
    it('properly renders with context wrapper changing props', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () { return (0, useAdder_1.useAdder)(); }, {
                        renderHook: {
                            wrapper: function (_a) {
                                var children = _a.children, prov1 = _a.prov1, prov2 = _a.prov2;
                                return (0, jsx_runtime_1.jsx)(useAdder_1.AdderProvider, __assign({ value: { prov1: prov1, prov2: prov2 } }, { children: children }));
