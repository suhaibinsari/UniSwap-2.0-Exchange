 ...
 * @internal
 */
var setupTestingConfig = function (_a) {
    var _b = _a === void 0 ? { multicallVersion: 1 } : _a, multicallVersion = _b.multicallVersion;
    return __awaiter(void 0, void 0, void 0, function () {
        var network1, network2, config;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, (0, createMockProvider_1.createMockProvider)({ chainId: model_1.Mainnet.chainId, multicallVersion: multicallVersion })];
                case 1:
                    network1 = _d.sent();
                    return [4 /*yield*/, (0, createMockProvider_1.createMockProvider)({ chainId: deployMockToken_1.SECOND_TEST_CHAIN_ID, multicallVersion: multicallVersion })];
                case 2:
                    network2 = _d.sent();
                    config = {
                        readOnlyChainId: model_1.Mainnet.chainId,
                        readOnlyUrls: (_c = {},
                            _c[model_1.Mainnet.chainId] = network1.provider,
                            _c[deployMockToken_1.SECOND_TEST_CHAIN_ID] = network2.provider,
                            _c),
